...
<div class="form1" style="margin-left:11%">
	...
	<form:form action="/registerForUser" method="post" modelAttribute="newUser"  style="width :400px;margin-left: 15%;">
	  ...
	  <div class="form-group">
	    ...
	    <form:input path= "phoneNumber" type="email" class="form-control" id="exampleInputPassword1" placeholder="Phone Number"></form:input>
	  </div>
	  <div class="form-group">
...
<a href="">Are you a Programmer ?  register Here </a>
</body>
</html>