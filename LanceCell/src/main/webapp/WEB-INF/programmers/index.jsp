...
<body>
	<header class="container">
		<h1 class="text-center text-primary">Programmer Page</h1>
	</header>
	<main class="col" style="width:800px;margin-left:20%">
		<div class="row border mx-5 my-5">
			...
			<form:form action="/programmers/register" method="post" modelAttribute="newProgrammer">
				<div class="mb-3">
				...
				<div class="mb-3">
					<form:label path="github" class="form-label">Github:</form:label>
					<div>
						<form:errors path="github" class="text-danger small"></form:errors>
					</div>
					<form:input path="github" class="form-control" />
				</div>
				<div class="mb-3">
					<form:label path="linkedIn" class="form-label">LinkedIn:</form:label>
					<div>
						<form:errors path="linkedIn" class="text-danger small"></form:errors>
					</div>
					<form:input path="linkedIn" class="form-control" />
				</div>
				<div class="mb-3">
